...
public class NetworkConnection{
    ...
    NetworkConnection() throws UnsupportedEncodingException{        
        mUrl = "https://github.com/JacksonFurrier/Sftware-quality-and-testing";
    ...
    public String GetHttpRequest() throws MalformedURLException, IOException{
     ...
     //Task 2nd
     public String GetHttpRequestParameterized( URL aURL ) throws MalformedURLException, IOException
     {
        URLConnection vConnection = aURL.openConnection();        
        vConnection.setRequestProperty("Accept-Charset", mCharset);        
